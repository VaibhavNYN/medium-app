...
export const BlackButton = ({label, onClick}:{label: string, onClick : MouseEventHandler}) =>{
    return <div>
        ...
        text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700
         dark:focus:ring-gray-700 dark:border-gray-700" onClick={onClick}>{label}</button>
    </div>
}